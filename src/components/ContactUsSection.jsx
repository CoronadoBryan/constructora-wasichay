          ...
          <div className="contact-form bg-white">
            <div className="section-heading">
              ...
              <p className="section-heading__desc">
                ¿Necesitas apoyo en proyectos de construcción o topografía?
                Nuestro equipo de profesionales altamente calificados está listo
                para asistirte. Somos la opción preferida por muchos clientes en
                el sector de la construcción y la topografía.
              </p>
            </div>
                  ...
                  <div className="col-md-6 col-xs-6">
                    ...
                    <div className="form-group">
                      ...
                      <select
                        ...
                        required
                      >
                        <option value="Asesoría en Integración de Drones">
                          Asesoría en Integración de Drones
                        </option>
                        <option value="Capacitación en Uso de Drones">
                          Capacitación en Uso de Drones
                        </option>
                        <option value="Análisis de Proyectos Topográficos">
                          Análisis de Proyectos Topográficos
                        </option>
                        <option value="Asesoría en Normativas y Regulaciones">
                          Asesoría en Normativas y Regulaciones
                        </option>
                        <option value="Casos de Éxito y Mejores Prácticas">
                          Casos de Éxito y Mejores Prácticas
                        </option>
                        <option value="Soporte Técnico y Postventa">
